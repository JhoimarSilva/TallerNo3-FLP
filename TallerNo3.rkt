...
(define (evaluar-expresion exp entorno)
  (match exp
    ...
    ; Agregar caso para llamada recursiva
    [(list 'llamar-recursivo nombre argumentos) (evaluar-llamar-recursivo exp entorno)]
...
<expresion> := <numero>
             ...
             := evaluar <expresion> (expresion ',' <expresion>)* finEval
             := llamar <identificador> (expresion ',' <expresion>)* finLlamar